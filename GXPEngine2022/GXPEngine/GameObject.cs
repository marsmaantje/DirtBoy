...
namespace GXPEngine
{
	...
	public abstract class GameObject : Transformable
	{
        ...
        public Vec2 TransformPoint(Vec2 point) => new Vec2(TransformPoint(point.x, point.y));
        ...
        public Vec2 InverseTransformPoint(Vec2 point) => new Vec2(InverseTransformPoint(point.x, point.y));
